...
//       <p style={{lineHeight:'15px', color:"#65728C",fontSize:'13px',marginTop:'4px',gap:'10px'}}>
...
//     <Card className="w-[700px] h-[350px]">
//       <h3 className="font-bold mb-4">AI Generated Prompt</h3>
//       <p>{generatedEmail}</p>
//     </Card>
//   );
