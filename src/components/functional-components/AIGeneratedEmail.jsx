...
// const handleSaveTemplate = (templateName, description) => {
//   console.log("Template Saved:", templateName, description);
//   handleCloseModal();
// };
  
//   return (
//     <Card className="w-[638px] h-[350px]">
     
//       <div className="flex justify-between items-center" style={{ borderBottom: '1px solid #EBEBEB', paddingBottom: '8px' }}>
...
//       <p style={{lineHeight:'15px', color:"#65728C",fontSize:'13px', marginTop:'4px'}}>
...
// <button className="bg-[#1565C0] text-[#F5F5F5] w-[148px] h-[37px] mt-4 mx-auto block rounded-[5px]"       onClick={handleOpenModal}
// >
//    Save Email Template
//   </button>
...
//     return (
//         <Card className="w-full max-w-[700px] h-[350px] mx-auto">
//             <div className="flex justify-between items-center" style={{ borderBottom: '1px solid #EBEBEB', paddingBottom: '8px' }}>
//                 <h3 className="font-bold mb-0">AI Generated Email Template</h3>
//                 <div className="flex space-x-2">
//                     <LikeOutlined
